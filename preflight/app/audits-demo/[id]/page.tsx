...
export default function AuditDemoDetail({ params }: Props) {
  const id = params.id;
  const result = mockAudit;

  return (
    <main className="min-h-screen bg-app text-app p-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-4">
          <Link href="/audits-demo" className="text-sm text-muted hover:text-app">← Torna agli audit demo</Link>
        </div>

        <h1 className="text-2xl font-bold mb-2">Audit Demo #{id}</h1>
