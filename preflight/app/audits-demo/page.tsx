...
export default function AuditsDemo() {
  return (
    <main className="min-h-screen bg-app text-app">
      <div className="mx-auto max-w-5xl px-6 py-14">
        <h1 className="text-3xl font-bold">Audit (Demo pubblico)</h1>
        <p className="mt-4 text-muted">Questa è una demo pubblica degli audit.</p>
            ...
            <Card key={p.id}>
              <div className="flex items-start justify-between">
                ...
                <div className="text-right">
                  ...
                  <Link href={`/audits-demo/${p.id}`} className="block mt-3 text-sm link-primary">Apri</Link>
                </div>
              </div>
