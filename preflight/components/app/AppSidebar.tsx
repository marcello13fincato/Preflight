...
export default function AppSidebar() {
  ...
  return (
    <aside className="sb fade-in">
      {/* Logo */}
      <div className="sb-brand">
        <Link href="/app" style={{ display: "flex", alignItems: "center", gap: "0.65rem", textDecoration: "none" }}>
          <img
            src="/LOGO PREFLIGHT_Pittogramma.png"
            alt="Preflight"
            style={{ height: 32, width: "auto", filter: "brightness(0) invert(1) drop-shadow(0 1px 4px rgba(0,0,0,0.2))" }}
          />
