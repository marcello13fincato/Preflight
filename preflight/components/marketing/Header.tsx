  ...
  return (
    <header className="sticky top-0 z-50 bg-background/90 backdrop-blur-sm border-b border-border shadow-sm">
      <div className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm text-text-primary">
        ...
        <div className="flex items-center gap-4">
          <Link
            ...
            className="rounded-full bg-primary px-5 py-2 text-text-primary font-semibold shadow-sm hover:bg-primary-hover transition"
          >
            {marketingCTA.label}
          </Link>
        </div>
