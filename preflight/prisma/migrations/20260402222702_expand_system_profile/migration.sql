...
INSERT INTO "new_SystemProfile" ("clienteIdeale", "createdAt", "id", "linkedinLinks", "materialiNomi", "problemaCliente", "risultatoCliente", "servizio", "socialLinks", "tempoSettimanale", "updatedAt", "userId") SELECT "clienteIdeale", "createdAt", "id", "linkedinLinks", "materialiNomi", "problemaCliente", "risultatoCliente", "servizio", "socialLinks", "tempoSettimanale", "updatedAt", "userId" FROM "SystemProfile";
